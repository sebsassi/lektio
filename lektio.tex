...
\begin{frame}
    ...
    \begin{tikzpicture}[
        ...
        \draw[speed arrow] (sun) +(105:1.7cm) arc [radius = 1.7cm, start angle = 105, end angle = 75] node[above, pos = 0.5] {\tiny 30 km/s};
        ...
        \node at ($(earth) + (-2.0cm,0.99)$) [above = 0.2cm] {\tiny Pimeän aineen tuuli};
...
\begin{frame}
    ...
    \begin{tikzpicture}[
        ...
        \begin{axis}[
            ...
            \node at (axis cs:0,0) [opacity = 0.7]{
...
\begin{frame}
    ...
    \begin{tikzpicture}
        ...
        \draw[photon] (atom) +(-110:2cm) -- +(-110:3.5cm);
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+ [\defaulttextcolor, -stealth] coordinates { (0,0.6) (1,1) } node[sloped, pos = 0.5, above]{\tiny Sironnan todennäköisyys};
            \addplot+ [\defaulttextcolor, -stealth] coordinates { (0,0.4) (1,0) } node[sloped, pos = 0.5, below]{\tiny Energia};
        \end{axis}
    \end{tikzpicture}
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture} [
        ...
        \node at (xenon) {\color{\defaultbgcolor} nestemäistä jalokaasua};
        ...
        \node at (crystal) [below = 1.3cm]{Germanium-kristalli};
...
\begin{frame}
    ...
    \begin{tikzpicture}
        ...
        \node[circle] (atom1) at ($(base1) + (0.75, 0.75)$) {};
        \node[circle, ball color = black!70!white] (dm1) at ($(base1) + (-0.75, 0.3)$) {};
        \draw[-stealth] (dm1) -- (atom1);
        \foreach \x in {0, 1.5, 3.0}
            \foreach \y in {0, 1.5, 3.0}
                \fill[white] (base1) +(\x,\y) circle [radius = 0.1cm];
        \foreach \x in {0, 1.5}
            \foreach \y in {0, 1.5}
                \fill[white] (base1) +($(\x,\y) + (0.75, 0.75)$) circle [radius = 0.1cm];
        
        % frame 2
        \coordinate (base2) at (4.5,0);
        \node[circle] (atom2) at ($(base2) + (0.75, 0.75)$) {};
        \node[circle] (dm21) at ($(base2) + (-0.75, 0.3)$) {};
        \node[circle, ball color = black!70!white] (dm22) at ($(base2) + (-0.75, 1.2)$) {};
        \draw[-stealth] (dm21) -- (atom2.west) -- (dm22);
        \fill[white] (atom2) + (0.15,0) circle [radius = 0.1cm];
        \foreach \x in {0, 1.5, 3.0}
            \foreach \y in {0, 1.5, 3.0}
                \fill[white] (base2) +(\x,\y) circle [radius = 0.1cm];
        \fill[white] (base2) +($(0,1.5) + (0.75, 0.75)$) circle [radius = 0.1cm];
        \fill[white] (base2) +($(1.5,0) + (0.75, 0.75)$) circle [radius = 0.1cm];
        \fill[white] (base2) +($(1.5,1.5) + (0.75, 0.75)$) circle [radius = 0.1cm];

        % frame 3
        \coordinate (base3) at (9.0,0);
        \coordinate (atom31) at ($(base3) + (0.75, 0.75)$) {};
        \coordinate (atom32) at ($(base3) + (1.5, 1.5)$) {};
        \coordinate (atom33) at ($(base3) + (2.25,2.25)$) {};
        \fill[white] (atom31) + (1.125,1.125) circle [radius = 0.1cm];
        \foreach \x in {0, 1.5, 3.0}
            \foreach \y in {0, 1.5, 3.0}
                \fill[white] (base3) +(\x,\y) circle [radius = 0.1cm];
        \fill[white] (base3) +($(0,1.5) + (0.75, 0.75)$) circle [radius = 0.1cm];
        \fill[white] (base3) +($(1.5,0) + (0.75, 0.75)$) circle [radius = 0.1cm];
        \fill[white] (base3) +($(1.5,1.5) + (0.75, 0.75)$) circle [radius = 0.1cm];
        \draw[-stealth] (-0.2cm,-2.2cm) -- (-0.2cm,-0.5cm) node [sloped, pos = 0.5, above] {\tiny Energia};
        %\draw (-0.2cm,-2.2cm) -- +(12cm,0);
        \begin{scope}[shift = {(0,-0.3cm)}]
            \fill[white] (0.75cm,-1.5cm) circle [radius = 0.1cm];
            \draw (0,-0.6cm)
                ...
                .. (2.25cm,-0.7cm);
        \end{scope}
        \begin{scope}[shift = {(4.5cm,-0.3cm)}]
            \fill[white] (0.9cm,-1.3cm) circle [radius = 0.1cm];
            \draw (0,-0.6cm)
                ..controls (1.05cm,-3.0cm) and (1.0cm,-0.5cm)
                .. (1.69cm, -0.78cm)
                ..controls (1.9cm,-0.9cm)
                .. (2.25cm,-0.7cm);
        \end{scope}
        \begin{scope}[shift = {(9.0cm,-0.3cm)}]
            \fill[white] (1.875cm,-0.7cm) circle [radius = 0.1cm];
            \draw (0,-0.6cm)
                ..controls (1.05cm,-3.0cm) and (1.0cm,-0.5cm)
                .. (1.69cm, -0.78cm)
                ..controls (1.9cm,-0.9cm)
