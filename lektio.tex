...
\title{Pimeä aine uuden sukupolven detektoreissa}
    ...
    \begin{tikzpicture} [
        ...
        \begin{axis}[
            ...
            \addplot+ [visible on = <1->]
                ...
                node [sloped, above, pos = 0.95, font = \tiny] {odotus};
            \addplot+ [visible on = <2->]
                table [col sep = comma] {rotation_dark.csv}
                node [sloped, above, pos = 0.95, font = \tiny] {mitattu};
        \end{axis}
    \end{tikzpicture}
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture}[
        ...
        \begin{scope}[visible on = <1->]
            ...
            \node at ($(dm halo) + (0, 1.2cm)$) [font = \tiny] {
                Pimeää ainetta};
            \node (mw annot) at ($(dm halo) + (-1.5cm, -1cm)$) [font = \tiny] {
                Linnunrata};
        ...
        \begin{scope}[visible on = <3->]
            ...
            \draw[speed arrow]
                ...
                node [above, pos = 0.5, font = \tiny] {30 km/s};
            \draw[speed arrow]
                (sun) +(-75:1.7cm)
                arc [
                    radius = 1.7cm,
        ...
        \begin{scope}[visible on = <4->]
            ...
            \node at ($(earth) + (-2.0cm,0.99)$) [above = 0.2cm, font = \tiny] {
                Pimeän aineen tuuli};
        ...
        \begin{axis}[
            ...
            \addplot+ [mark = *, mark color = white, color=white]
                ...
                node [
                        ...
                        font = \tiny] {
                    Pieni Otava};
            \addplot+ [mark = *, color = scp-blue-dark-1]
                table {star_map/vlab_2025-03-06-21-00.dat}
                node (dm wind) {};
            \node[visible on = <1>]
                (annot) at (0,0.5) [align = center, left, font = \tiny] {
                    Maan liikkeen suunta\\ galaksin suhteen};
            \draw[visible on = <1>, -stealth] (annot) to [out = 0, in = 90] (dm wind);
        \end{axis}
    \end{tikzpicture}
\end{frame}
    ...
    \begin{tikzpicture}
        \begin{scope}
            ...
            \node[visible on = <1->, circle, ball color = black!70!white]
                (dm) at (135:3.5cm) {};
            \node[visible on = <1->]
                at (135:3.5cm) [above right, font = \tiny] {
                    pimeä aine};
            \draw[visible on = <1->, -stealth]
                (45:3.5cm) -- (atom.north) -- (dm);
            \draw[visible on = <1->, -stealth]
                (atom) -- +(-90:3cm);
            \node[visible on = <2->, circle, minimum size=0.3cm]
                (ionize) at ($(atom) + (-60:3.5cm)$) {};
            \pic[visible on = <2->] at (ionize) [very thick, scale = 0.4] {
                electron};
            \draw[visible on = <2->, -stealth]
                (atom) +(-60:2cm) -- (ionize);
            \node[visible on = <2->]
                at (ionize) [below right, font = \tiny] {
                elektroni};
            \draw[visible on = <3->, photon]
                (atom) +(-110:2cm) -- +(-110:3.5cm)
                node [above, sloped, pos = 0.5, font = \tiny] {
                    fotoni};
        \end{scope}
        \begin{axis}[
            visible on = <4->,
            ...
            \addplot+ [\defaulttextcolor, -stealth]
                ...
                node [sloped, pos = 0.5, above, font = \tiny] {
                    Sironnan todennäköisyys};
            \addplot+ [\defaulttextcolor, -stealth]
                coordinates { (0,0.4) (1,0) }
                node [sloped, pos = 0.5, below, font = \tiny]{
                    Energia};
        \end{axis}
    \end{tikzpicture}
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
        \node[visible on = <2->]
            at (3.0,-1) [align = center, below] {
                Avainkysymyksiä:\\
                Mitä päivittäinen vaihtelu kertoo pimän aineen vuorovaikutuksista/jakaumasta?\\
                Auttaako päivittäinen vaihtelu pimeän aineen löytämisessä?};
    \end{tikzpicture}
\end{frame}
